...
<head>
	...
	<title>Reservations - El Paso</title>
	<style>
	</style>
</head>
<body>
	...
	<a href="reservations.php" class="table-refresh">REFRESH</a>
  	...
  	<div class="container_booked">
		...
		if ($dbc) {
			...
			$query = "SELECT * FROM reservations WHERE date >= CURDATE() ORDER BY date, time";
			...
			while($row = mysqli_fetch_array($result)) {
				...
				<div class='space1'><a href='somepage.php?id=".$row['id']."'>Details</a></div>
				</li>";
			}
			}
		}
